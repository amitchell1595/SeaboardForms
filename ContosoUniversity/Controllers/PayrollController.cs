...
namespace ContosoUniversity.Controllers
{
    public class PayrollController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PayrollID,PayrollName")] Payroll payroll)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PayrollID,PayrollName")] Payroll payroll)
        {
            if (ModelState.IsValid)
            {
